...
export default function SignUp() {
  const [email, setEmail] = useState('dola@gmail.com');
  ...
  return (
    <>
      <section className='w-screen h-screen absolute top-0 left-0 bottom-0 right-0 flex flex-col items-center justify-center'>
        <form className='w-fit h-fit px-10 py-10 rounded-md bg-white' method='POST' onSubmit={deleteAccount}>
        <div className='w-fit h-fit bg-gradient-to-r from-red-500 via-blue-500 to-green-500 bg-clip-text'>
          ...
          <p className='text-2xl text-gray-700 font-bold my-4'> Delete Account </p>
          ...
          <p className='text-gray-500 font-semibold text-sm'> Change your mind? Go back to <span className='text-blue-500 font-bold'> <Link href="/login"> Home. </Link> </span> </p>
          <br />

          <div className='flex justify-end'>
            <input type="submit" value="Delete Account" className='text-white bg-red-500 rounded-md px-6 py-2 cursor-pointer' />
          </div>
        </form>
      </section>
    </>
